...
urlpatterns = [
	...
	path('users/interests/delete/<str:interest>/', user_views.delete_interest, name='delete_interest'),
	path('users/interests/add/',user_views.interests,name='add_interests'),
